...
( function( $ ) {
	...
	wp.customize( 'noo_header_nav_link_color', function( value ) {
		value.bind( function( newval ) {
			...
			// NavBar style
			additionalStyle = 'header .noo-main-menu .navbar-nav li > a {color: ' + newval + ' !important;}';
			// Dropdown style
            additionalStyle += 'header .noo-main-menu .navbar-nav ul.sub-menu li > a {color: ' + newval + ' !important;}';
	...
	wp.customize( 'noo_header_nav_link_hover_color', function( value ) {
		value.bind( function( newval ) {
			...
			// NavBar style
			additionalStyle = 'header .noo-main-menu .navbar-nav li > a:hover,.noo-main-menu .navbar-nav li > a:focus,.noo-main-menu .navbar-nav li:hover > a {color: ' + newval + ' !important;}';

			// Dropdown style
            additionalStyle += 'header .noo-main-menu .navbar-nav ul.sub-menu li > a:hover,.noo-main-menu .navbar-nav ul.sub-menu li > a:focus,.noo-main-menu .navbar-nav ul.sub-menu li:hover > a,.noo-main-menu .navbar-nav ul.sub-menu li.sfHover > a,.noo-main-menu .navbar-nav ul.sub-menu li.current-menu-item > a {color: ' + newval + ' !important;}';
