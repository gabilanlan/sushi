...
if( $noo_typo_use_custom_headings_font ) :
    ...
    $noo_typo_headings_font_weight = noo_organici_get_option( 'noo_typo_headings_font_weight');
?>
    /* Headings */
    /* ====================== */
    h1, h2, h3, h4, h5, h6,
...
if( $noo_typo_use_custom_body_font ) :
    ...
    $noo_typo_body_font_weight = noo_organici_get_option( 'noo_typo_body_font_weight');
?>
    /* Body style */
    /* ===================== */
     body {
