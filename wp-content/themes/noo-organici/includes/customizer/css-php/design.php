...
$noo_site_secondary_hover_color     =   noo_organici_get_option( 'noo_site_secondary_color', noo_organici_get_theme_default( 'secondary_color' ) );
...
$noo_site_secondary_hover_color_fade_80 = noo_organici_css_fade( $noo_site_secondary_hover_color, '80%' );
?>
/**
 * Heading Custom
 * ==================
...
.noo-footer-shop-now h4 strong {
	color: <?php echo esc_attr($noo_site_secondary_hover_color); ?>
}
...
.has-cart em {
	background: <?php echo esc_attr($noo_site_secondary_hover_color); ?>
}
.bg-secondary {
	background: <?php echo esc_attr($noo_site_secondary_hover_color_fade_80); ?>
}
