...
$noo_header_logo_uppercase    =     noo_organici_get_option( 'noo_header_logo_uppercase', true ) ? 'uppercase': 'normal';
$noo_header_logo_font_weight  =     noo_organici_get_option('noo_header_logo_font_weight');
// Navigation
...
if ( $noo_header_custom_nav_font ):
    ...
    $noo_header_nav_font_weight  =     noo_organici_get_option('noo_header_nav_font_weight');
?>
    /*nav
    * Typography for menu
    * ===============================
    */
    header .noo-main-menu .navbar-nav li > a{
        ...
        <?php endif; ?>
        <?php if( isset($noo_header_nav_font_weight) && !empty($noo_header_nav_font_weight) ): ?>
            font-weight: <?php echo esc_attr($noo_header_nav_font_weight); ?>
        <?php endif; ?>
    }

    /**
    * Header 4 and Header 6
    */

    <?php if ( $noo_header_nav_color != '' ): ?>
    .noo-header.header-6 .noo-main-menu .navbar-nav li > a, .noo-header.header-4 .noo-main-menu .navbar-nav li > a {
        color: <?php echo esc_attr( $noo_header_nav_color ) ; ?>;
    }
    <?php endif; ?>
   ...
   <?php if ( $noo_header_fix_logo_image_height ) : ?>
    ...
    header .navbar-brand{
        ...
        <?php if( $noo_header_use_image_logo == false): ?>
            ...
            <?php if( isset($noo_header_logo_font_weight) && !empty($noo_header_logo_font_weight) ): ?>
