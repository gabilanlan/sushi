...
function noo_organici_customizer_add_custom_controls( $wp_customize ) {
	...
	class NOO_Organici_Customize_Alpha_Color extends WP_Customize_Control 
	{
	    ...
	    public function enqueue()
	    {
	        wp_enqueue_script(
	            'alpha-color-picker',
	            NOO_FRAMEWORK_URI . '/assets/js/alpha-color-picker/alpha-color-picker.js',
	        ...
	        wp_enqueue_style(
	            'alpha-color-picker',
	            NOO_FRAMEWORK_URI . '/assets/js/alpha-color-picker/alpha-color-picker.css',
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			if ( empty ( self::$font_weight_name ) )
				self::$font_weight_name = array(
					...
					'regular'   => esc_html__( 'Regular', 'noo-organici' ),
					'italic' 	=> esc_html__( 'Regular Italic', 'noo-organici' ),
