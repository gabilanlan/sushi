...
class Noo_Organici_Social  extends WP_Widget {
    ...
    */
            ...
            <div class="social-all">
                ...
                foreach($arg_social as $social):
                    if (!empty($instance[$social['id']])):
                        ?>
                        <a href="<?php echo esc_url($instance[$social['id']]); ?>" class="fa fa-<?php echo esc_attr($social['id']); ?>" <?php if( !empty( $target ) ) echo 'target="_blank"' ?>></a>
                    <?php
                    endif;
                endforeach;
                ?>
    ...
    public function  form($instrance) {
        ...
        <p>
            <input class="checkbox" type="checkbox" <?php checked( $instrance['target'] ); ?> id="<?php echo $this->get_field_id( 'target' ); ?>" name="<?php echo $this->get_field_name( 'target' ); ?>" />
            <label for="<?php echo $this->get_field_id( 'target' ); ?>"><?php esc_html_e( 'Click icon social open new tab?' , 'noo-organici'); ?></label>
        </p>
    <?php
    }
    ...
    function update( $new_instance, $old_instance ) {
        ...
        $instance['target']      = ( !empty( $new_instance['target'] ) ) ? (bool) $new_instance['target'] : false;
