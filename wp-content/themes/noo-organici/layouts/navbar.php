...
$topbar_on            = noo_organici_get_option( 'noo_header_top_on', false );
...
?>
<header class="noo-header <?php noo_organici_header_class(); ?> menu-eff-<?php echo esc_attr( $menu_reponsive ); ?>">
    <?php if( $topbar_on == 1 ): $has_topbar = 1; noo_organici_get_layout('topbar'); endif; ?>
                ...
                <div class="menu-position">
                    <div class="navbar-header pull-left">
                        ...
                        <div class="noo_menu_canvas">
                            ...
                            <?php endif; ?>
                            <?php
                                if( defined('WOOCOMMERCE_VERSION') && noo_organici_get_option( 'noo_header_nav_icon_cart' ) && noo_organici_get_option( 'noo_header_nav_icon_cart_on_mobile' ) ){
                                    echo noo_organici_minicart_mobile();
                                }
                            ?>
                            ...
                            <li class="menu-item fly-right">
                                <a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
                                    ...
                                    if(is_user_logged_in()){
                                        ...
                                        echo esc_html__('My Account', 'noo-organici');
                                    } else{
                                        echo '<i class="fa fa-sign-in"></i>';
                                        echo esc_html__('Log In / Sign Up', 'noo-organici');
                                    }
                                    ?>
                                </a>
                                <?php if(is_user_logged_in()): ?>
                                <ul class="fly-right-sub">
                                    <li><a href="<?php echo wp_logout_url(home_url()); ?>"><i class="fa fa-sign-out"></i><?php echo esc_html__('Log Out', 'noo-organici'); ?></a></li>
                                </ul>
                                <?php endif; ?>
                            </li>
                            <?php endif; ?>
                    ...
                    <?php
                        if( $header_style == 'header5' ):
                            $phone = noo_organici_get_option('noo_header_nav_phone') ? noo_organici_get_option('noo_header_nav_phone') : noo_organici_get_option('noo_header_top_phone');
                    ?>
                    <nav class="noo-header-anchor">
                       <ul>
                            ...
                            if(defined('WOOCOMMERCE_VERSION') && noo_organici_get_option('noo_header_nav_icon_cart',false)):
                                echo noo_organici_minicart();
                                echo noo_organici_minicart( true, true, esc_html__( 'MY CART', 'noo-organici' ) );
                            endif; ?>
                        </ul>
                    </nav>
                    <?php endif; ?>
