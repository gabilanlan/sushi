...
function smk_active_plugin(){
    $exported_data = '';
    ...
    if( isset($exported_data) && !empty($exported_data) ){
        if(is_serialized(base64_decode($exported_data))){
            ...
            if( is_array($exported_data) ){
                ...
                echo esc_html__('Data is not valid.','noo-starter');
            }
        }
        else{
            echo esc_html__('Data is not valid.','noo-starter');
...
add_action( 'activated_plugin', 'smk_active_plugin' );